    ...
    */
    ...
    describe('The menu', function(){
       ...
       */
       it('is hidden by default', function(){
         ...
         // VS jQuery --------WHY does it HAVE TO BE jQuery??
    ...
    describe('Initial Entries', function(){
       ...
       */
       ...
       it("loadFeed function called and completed", function(done) {
         //console.log(`$('.feed .entry').length = ${$('.feed .entry').length}`);
    ...
    describe('New Feed Selection', function(){
       ...
       */
       ...
       beforeEach(function(done) {
         loadFeed(0, function(){
           first = $('.feed .entry-link:first-child').attr("href");
           loadFeed(1, function(){
             second = $('.feed .entry-link:first-child').attr("href");
             done();
           });
         });
       });
